...
def main():
    ...
    if os.path.exists(common_path):
        ...
        if {"key", "value"}.issubset(df_c.columns):
            ...
            print("common.xlsx は 'key','value' 列を持つ必要があります。")
    ...
    # 3) terraform.tfvars を environment/<env>/ に出力
    env_dir = os.path.join("environment", env_value)
